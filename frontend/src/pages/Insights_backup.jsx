                    ...
                    {loading ? (
                        ...
                        <>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                                {/* AI Score */}
                                <div className="bg-gradient-to-br from-indigo-50 to-indigo-100 dark:from-indigo-900/20 dark:to-indigo-800/20 rounded-xl p-6 border border-teal-200 dark:border-teal-700/50">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                    ...
                                    <div className="bg-yellow-50 dark:bg-yellow-900/10 border border-yellow-200 dark:border-yellow-700/30 rounded-xl p-6">
                                        ...
                                        <p className="text-sm text-yellow-800 dark:text-yellow-400">
                                            Based on your current spending pattern, you'll exceed your food budget by â‚¹2,150 by month end.
                                        </p>
                                    </div>
                                    ...
                                    <div className="bg-cyan-50 dark:bg-cyan-900/10 border border-cyan-200 dark:border-cyan-700/30 rounded-xl p-6">
                                        ...
                                        <p className="text-sm text-cyan-800 dark:text-cyan-400">
                                            If you keep up the current trend, you could save â‚¹5,500 monthly. Great job!
                                        </p>
                                    </div>
        ...
        : 'bg-orange-100 dark:bg-orange-500/20 text-orange-700 dark:text-orange-400'
                                                ...
                                                <div className="flex items-center justify-between">
                                                    ...
                                                    <div className="flex gap-2">
                                                        <button
                                                            onClick={() => handleDismissAnomaly(insights.anomalies.indexOf(anomaly))}
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <p className="text-xl font-bold text-gray-900 dark:text-white">â‚¹{selectedAnomaly.amount.toLocaleString()}</p>
                                    </div>
                                    <div>
